...
# C:/Users/6126176/AppData/Local/Packages/CanonicalGroupLimited.Ubuntu_79rhkp1fndgsc/LocalState/rootfs/home/kaustubhmahesh/airflow/CONSOLIDATED_WORKER_HEADCOUNT_TEST.csv
    ...
    file_path='/usr/local/airflow/CONSOLIDATED_WORKER_HEADCOUNT_TEST(1).csv'
...
with DAG(
    ...
    def download_file_from_sftp():
        ...
        remote_file_path = '/Fieldglass/CONSOLIDATED_WORKER_HEADCOUNT_TEST(1).csv'

        local_file_path = 'CONSOLIDATED_WORKER_HEADCOUNT_TEST(1).csv'
